...
<div class="container-1">
	<div class="item-1 ">
		<h3 class=" desktop_section">ONLINE SHOPPING</h3>
		<h3 class="resposive_section">Shop For</h3>
		<ul>
			<li><a href="">Men</a></li>
			...
			<li class="desktop_section"><a href="">Gift Cards</a></li>
			<li class="desktop_section"><a href="">Myntra Insider <span class="new">New</span></a></li>
		</ul>
	...
	<div class="item-3">
		<h3 class="desktop_section">EXPERIENCE MYNTRA APP ON MOBILE</h3>
		<div class="footer-image-1 desktop_section">
	...
	<div class="item-4 desktop_section">
		<div class="item-4-title-1">
			...
			<div>
			<p><span>100% ORIGINAL</span> guarantee for</p>
			
			<p class=""> all products at myntra.com</p>
			</div>
		</div>
		<div class="item-4-title-2">
			<div>
			<img loading="lazy" src="https://constant.myntassets.com/web/assets/img/ef05d6ec-950a-4d01-bbfa-e8e5af80ffe31574602902427-30days.png" alt="" />
			</div>
			<div>
			<p><span>Return within 14 days</span> of</p>
			<p class="">receiving your order</p>
			</div>
		</div>
	</div>
</div>
<div class="container-2">
	...
	<div class="item-3">
		...
		<div class="item-3-title-2 desktop_section">
			<p>© 2024 www.myntra.com. All rights reserved.
			</p>
		</div>
		<div class="item-3-title-2 desktop_section ">
			<p>A Flipkart company
			</p>
		</div>
	</div>
	<span class="item-4-hr">
	</span>
</div>
