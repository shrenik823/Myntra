...
<div class="search-div desktop_section" >
<div class="search_img_outer">
<img src="../IMAGES/Nav-Bar/search.svg" alt="" class="search_img">
</div>
...
<div>
  ...
  <span id = "cart-count-info">0</span>
        ...
        <span  id = "mIcon"class ="resposive_section">

        <div class ="barsimgouter d_block">
        <img src="../IMAGES/Nav-Bar/icons8-menu.svg" alt="" class="">
        </div>
        <div class ="closeimgouter">
        <img src="../IMAGES/Nav-Bar/close_icon.svg" alt="" class="">
        </div>
